...
Usage:
  ...
  python -m demo.chat --ollama --ollama-model llama3
  python -m demo.chat --ollama --ollama-host http://localhost:11434 --ollama-model mistral

  # llama.cpp server
  python -m demo.chat --ollama --ollama-host http://localhost:8080 --ollama-model local

  # LM Studio
  python -m demo.chat --ollama --ollama-host http://localhost:1234 --ollama-model local
"""
