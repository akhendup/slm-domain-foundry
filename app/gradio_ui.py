...
Usage:
  python -m app.gradio_ui                          # auto-detect mode
  python -m app.gradio_ui --host 0.0.0.0          # bind to all interfaces
  python -m app.gradio_ui --model-dir output_model  # override model path
  DOCKER_CONTAINER=1 python -m app.gradio_ui       # force Docker paths
"""
